      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'AdminHomepage')
              : AdminHomepageWidget(
                  firstname: params.getParam('firstname', ParamType.String),
                  lastname: params.getParam('lastname', ParamType.String),
                  adminLifeCode:
                      params.getParam('adminLifeCode', ParamType.String),
                ),
        ),
        FFRoute(
          name: 'AdminLifeguardsManagment',
          path: '/adminLifeguardsManagment',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'AdminLifeguardsManagment')
              : AdminLifeguardsManagmentWidget(
                  firstname: params.getParam('firstname', ParamType.String),
                  lastname: params.getParam('lastname', ParamType.String),
                  adminLifeCode:
                      params.getParam('adminLifeCode', ParamType.String),
        ...
        FFRoute(
          ...
          path: '/adminHistory',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'AdminHistory')
              : AdminHistoryWidget(
                  firstname: params.getParam('firstname', ParamType.String),
                  lastname: params.getParam('lastname', ParamType.String),
                  adminLifeCode:
